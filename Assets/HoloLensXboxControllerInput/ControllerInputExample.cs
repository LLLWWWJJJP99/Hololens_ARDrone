...
public class ControllerInputExample : MonoBehaviour {
    ...
    void Update () {
        ...
        ///////////////////////////////////////////////////////////
        this.transform.Rotate(mycamera.transform.rotation.x * RotateAroundXSpeed, mycamera.transform.rotation.y * RotateAroundYSpeed, mycamera.transform.rotation.z * RotateAroundZSpeed);
